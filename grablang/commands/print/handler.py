    ...
    def _format_value_normal(self, value: Any, variable_name: str) -> str:
        ...
        if isinstance(value, BeautifulSoup):
            ...
            if count == 0:
                ...
                # Si un seul élément, affiche directement son contenu
                element = value[0]
                text_content = element.get_text(strip=True)
                if text_content:
                    return text_content
                else:
                    # Si pas de texte, affiche la structure de l'élément
            ...
            # Pour un élément unique, affiche directement le contenu
            ...
            if len(value) == 1:
                # Si un seul élément dans la liste, affiche directement son contenu
                item = value[0]
            ...
            # Pour une chaîne, affiche directement le contenu
            return value
